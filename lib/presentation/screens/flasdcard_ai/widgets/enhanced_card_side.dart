...
// Enhanced card side with consistent styling
            ...
            child: Column(
              ...
              children: [
                if (widget.isContentPrimary) ...[
                  ...
                  // Vocabulary word (centered and large)
                  Text(
                    widget.content,
                    style: const TextStyle(
                      fontSize: 32,
                  ...
                  // Pronunciation (below the vocabulary word)
                  ...
                  // Back arrow and title in a row for definition side
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      IconButton(
